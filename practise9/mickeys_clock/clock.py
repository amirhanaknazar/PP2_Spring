...
class MickeyClock:
    def __init__(self, screen_width, screen_height):
        ...
        self.min_hand_orig = pygame.image.load(os.path.join(img_dir, "right.png")).convert_alpha()
        self.min_hand_orig = pygame.transform.scale(self.min_hand_orig, (300, 350))
        
        self.sec_hand_orig = pygame.image.load(os.path.join(img_dir, "left.png")).convert_alpha()
        self.sec_hand_orig = pygame.transform.scale(self.sec_hand_orig, (350, 350))
